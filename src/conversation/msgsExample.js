...
export const NeuralNetworkArch = `I can make quick changes to the architecture, including network depth (&#8226; use 10 layers &#8226; add a layer &#8226; remove the last 4 layers), and dimensionality (&#8226; use 3 inputs &#8226; 2 outputs)`;
